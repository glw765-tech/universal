  ...
  return (
    ...
    >
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          By completing payment you acknowledge that this fee is for access to the ritual experience, not for the delivery of any physical product or guaranteed outcome.
        </p>
      </section>
