...
export function Scene3() {
  ...
  return (
    ...
    >
      <motion.h2 
        className="font-body font-light text-2xl md:text-4xl text-[var(--color-text-secondary)] tracking-widest uppercase mb-20 text-center"
      ...
      <div className="relative w-full max-w-5xl flex justify-between items-center px-10">
        ...
        {stages.map((stage, i) => (
          <div key={stage} className="relative flex flex-col items-center z-10">
            ...
            >
              <span className="font-display text-xl md:text-2xl text-[var(--color-text-primary)]">
                {stage}
              </span>
            </motion.div>
          </div>
